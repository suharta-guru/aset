<div class="row g-4">
    <div class="col-md-4">
        <div class="card border-0 shadow-lg rounded-4 h-100 ">
            <div class="card-body p-4">
                <h5 class="card-title fw-bold mb-4 text-dark">
                    Tambah Pengelola
                </h5>
                
                <form>
                     <h6 class="text-secondary small fw-bold">Nama Pegawai</h6>
                    <div class="form-floating mb-3">
                        <select name="pegawai_id" id="pegawaiSelect" class="form-select rounded-3 border-0 bg-light shadow-none">
                                <option value="" selected disabled>Pilih Pegawai</option>
                                <option value="1">Andi Permana</option>
                                <option value="2">Siti Rahmawati</option>
                                <option value="3">Budi Santoso</option>
                        </select>                    
                    </div>
                     <h6 class="text-secondary small fw-bold">Role Pegawai</h6>
                        <div class="form-floating mb-4">
                            <select name="role_id" id="pegawaiRole" class="form-select rounded-3 border-0 bg-light shadow-none">
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg rounded-pill shadow-sm fw-bold fs-6">
    ...
    <div class="p-4 border-bottom d-flex flex-wrap gap-3 justify-content-between align-items-center bg-white">
        <div>
            <h6 class="fw-bold mb-0">Pengelola</h6>
        </div>
        ...
        <table class="table table-premium mb-0 align-middle table-hover">
            <thead class="bg-light">
                <tr>
                    ...
                    <th class="text-center py-3 text-uppercase small fw-bold text-secondary">Aksi</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td class="text-end pe-4">
                        <div class="d-flex justify-content-end gap-2">
                            <a href="?pg=kpengelola&fl=edit" class="btn btn-sm text-primary bg-primary bg-opacity-10 border-0 rounded-2" style="width: 32px; height: 32px; display: inline-flex; align-items: center; justify-content: center;"><i class="bi bi-pencil-square"></i></a>
                            <a href="?pg=kpengelola&fl=hapus" class="btn btn-sm text-danger bg-danger bg-opacity-10 border-0 rounded-2" style="width: 32px; height: 32px; display: inline-flex; align-items: center; justify-content: center;"><i class="bi bi-trash"></i></a>
                        </div>
                    </td>
                </tr>
                <tr>
    ...
    <div class="p-3 border-top d-flex justify-content-between align-items-center bg-white">
        ...
        <nav>
            <ul class="pagination pagination-sm mb-0">
                ...
                <li class="page-item active"><a class="page-link border rounded-2" href="#">2</a></li>
