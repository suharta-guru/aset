<div class="card border-0 shadow-sm rounded-3 overflow-hidden">
    ...
    <div class="p-4 border-bottom bg-white d-flex justify-content-between align-items-center">
        <div>
            <h6 class="fw-bold mb-0">Edit Data Serah Terima</h6>
            <small class="text-muted">Revisi item aset pada surat BAST.</small>
        </div>
    ...
    <div class="card-body p-4">
        ...
        <h6 class="fw-bold text-dark mb-3 small text-uppercase"> <i class="bi bi-plus-square me-1"></i> Tambah Item Aset</h6>
        <div class="d-flex flex-wrap align-items-end gap-3 mb-4 p-3 bg-light rounded-3 border border-light">
            <div class="flex-grow-1">
                <label class="form-label small fw-bold text-secondary">Pilih Aset Tambahan</label>
                <div class="input-group">
                    ...
                    <select class="form-select border shadow-none">
                        <option selected disabled>-- Cari Barang Lain --</option>
                        <option value="PR05">Proyektor Epson (PR-GA-005)</option>
                        <option value="HDMI">Kabel HDMI 5m (CB-IT-010)</option>
                    </select>
                </div>
            </div>
            <div>
                <button type="button" class="btn btn-primary px-4">
                    <i class="bi bi-arrow-down-circle me-1"></i> Masukkan
                </button>
            </div>
        </div>
