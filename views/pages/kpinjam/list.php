<div class="card border-0 shadow-sm rounded-3 overflow-hidden">
    ...
    <div class="p-4 border-bottom d-flex flex-wrap gap-3 justify-content-between align-items-center bg-white">
        <div>
            <h6 class="fw-bold mb-0">Daftar Hapus Asset (BAST)</h6>
            <small class="text-muted">Kelola data penghapusan aset</small>
        </div>
        <div class="d-flex gap-2">
            ...
            <a href="?pg=<?= $pg ?>&fl=tambah" class="btn btn-primary btn-sm">
                ...
                <tr>
                    ...
                    <td class="text-end pe-4">
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <a href="?pg=<?= $pg ?>&fl=edit" class="btn btn-sm text-primary bg-primary bg-opacity-10 border-0 rounded-2" style="width: 32px; height: 32px; display: inline-flex; align-items: center; justify-content: center;" title="Edit Surat">
                                <i class="bi bi-pencil-square"></i>
                            </a>
                            <a href="?pg=<?= $pg ?>&fl=hapus&id=001" onclick="return confirm('Yakin ingin menghapus surat ini?')" class="btn btn-sm text-danger bg-danger bg-opacity-10 border-0 rounded-2" style="width: 32px; height: 32px; display: inline-flex; align-items: center; justify-content: center;" title="Hapus Surat">
